...
class Project {
	...
	protected function __construct() {
		...
		global $SoS_State;$SoS_State = State::get_instance();
		global $SoS_Query;$SoS_Query = Query::get_instance();
		...
		global $SoS_Mobile;$SoS_Mobile = Mobile::get_instance();
		global $SoS_Import;$SoS_Import = Import::get_instance();
